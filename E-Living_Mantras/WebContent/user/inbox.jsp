	...
	<div id="ssb-container" class="ssb-btns-right ssb-anim-slide" style="z-index: 999; right: -40px; height: 200px; ">
		<ul class="ssb-light-hover">
			<li id="ssb-btn-0" style="background-color: red; height: 60px;  border-radius: 10px; ">
				<p>
					<a href="/E-Living_Mantras/user/inbox.jsp"><span style="font-size: 30px; color: black; "><i class="fa fa-inbox" style="margin-left: 40%"></i><br>Inbox</span> </a>
				</p>
			</li>
			<li id="ssb-btn-1" style="background-color: blue; height: 60px; border-radius: 10px;">
				<p>
					<a href="/E-Living_Mantras/user/sentitems.jsp"><span style="font-size: 30px; color: black;  "><i class="fas fa-paper-plane" style="margin-left: 40%"></i><br>Sent Items</span> </a>
				</p>
			</li>
			<li id="ssb-btn-2" style="background-color: red; height: 60px; border-radius: 10px;">
				<p>
					<a href="/E-Living_Mantras/user/compose.jsp"><span style="font-size: 30px; color: black;"><i class="fa fa-rocket" style="margin-left: 40%"></i><br>Compose</span> </a>
				</p>
			</li>
		</ul>
	</div>
