					...
					<div class="col-lg-4 left-sidebar p-3 border">
						<div class="row">
							<div class="col-lg-12">
								<ul class="nav">
						            <li class="nav-item">
						                <a class="nav-link" href="/E-Living_Mantras/user/inbox.jsp"><i class="fa fa-inbox"></i> Inbox</a>
						            </li>
						            <li class="nav-item">
						                <a class="nav-link" href="/E-Living_Mantras/user/sentitems.jsp"><i class="fas fa-paper-plane"></i>Sent Items</a>
						            </li>
						            <li class="nav-item">
