					...
					<div class="col-lg-4 left-sidebar p-3 border">
						<div class="row">
							<div class="col-lg-12">
								<ul class="nav">
						            <li class="nav-item">
						                <a class="nav-link" href="/E-Living_Mantras/jsp/inbox.jsp"><i class="fa fa-inbox"></i> Inbox</a>
						            </li>
						            <li class="nav-item">
						                <a class="nav-link" href="/E-Living_Mantras/jsp/sentitems.jsp"><i class="fas fa-paper-plane"></i>Sent Items</a>
						            </li>
						            <li class="nav-item">
					...
					<div class="col-lg-8 messege-right p-3 border">
						<div class="row m-0">
							...
							<div class="col-lg-12 p-0 message-box-input">
								<form action="/E-Living_Mantras/Message" method="post">
								  	<div class="form-group">
								    	<input type="email" class="form-control" name="reciverid" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Reciever's Id">
